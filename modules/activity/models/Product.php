...
class Product extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['mycatid', 'typeid', 'areaid', 'pid', 'level', 'elite', 'price', 'days', 'hits', 'groupid', 'vip', 'validated', 'totime', 'edittime', 'addtime', 'auto_shelve_time', 'auto_shelf_time', 'auto_shelf_days', 'status', 'total_func', 'sccs', 'jifen', 'shuliang', 'activeid', 'menshiid', 'menshiprice', 'minamountbak', 'buytimes', 'disnoneprice', 'buytimesall', 'first_price_addtime'], 'integer'],
