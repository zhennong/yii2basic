...
use app\modules\test\models\Products;

/**
 * ProductsSearch represents the model behind the search form about `app\modules\test\models\Products`.
 */
class ProductsSearch extends Products
{
    ...
    {
        return [
            [['itemid', 'mycatid', 'type', 'special_id', 'typeid', 'areaid', 'pid', 'level', 'elite', 'price', 'days', 'hits', 'groupid', 'vip', 'validated', 'totime', 'production_time', 'edittime', 'addtime', 'auto_shelve_time', 'auto_shelf_time', 'auto_shelf_days', 'status', 'total_func', 'sccs', 'jifen', 'shuliang', 'activeid', 'menshiid', 'menshiprice', 'minamountbak', 'buytimes', 'disnoneprice', 'buytimesall', 'first_price_addtime'], 'integer'],
